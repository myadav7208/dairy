        ...
        <?php
            ...
            <div class="table-responsive" >
                <table class="table table-bordered text-center " id="staff-table" >
                    ...
                    <tbody>
                        <?php 
                                $query2 = "select sum(trd.quantity) total_quantity, sum(trd.quantity)*tc.rate tamount, trd.date_time dt from tbl_milk_delivered trd inner join tbl_client tc on trd.client_id = tc.id where trd.client_id=$dm_id and cast(trd.date_time as date) between '$from_date' and '$todate' group by trd.date_time order by trd.date_time";
